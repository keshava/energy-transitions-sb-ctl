...
class License(object):
    ...
    def name(self, name):
        ...
        allowed_values = ["CC0-1.0", "CC-BY-SA-4.0", "GPL-2.0", "SDU-1.0", "CC-BY-NC-SA-4.0", "unknown", "DbCL-1.0", "CC-BY-SA-3.0", "copyright-authors", "other", "reddit-api", "world-bank"]  # noqa: E501
